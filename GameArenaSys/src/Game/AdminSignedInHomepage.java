...
public class AdminSignedInHomepage extends javax.swing.JFrame {

    /**
     * Creates new form SignedInHomepage
     */
    public AdminSignedInHomepage() {
        initComponents();
    }
    
    AdminSchedule schedPage = new AdminSchedule();
    ...
    private void initComponents() {
        ...
        updateSeatsBtn = new javax.swing.JButton();
        ...
        updateSeatsBtn.setBackground(new java.awt.Color(204, 204, 204));
        updateSeatsBtn.setFont(new java.awt.Font("Arial", 0, 13)); // NOI18N
        updateSeatsBtn.setForeground(new java.awt.Color(255, 255, 255));
        updateSeatsBtn.setText("Update seats");
        updateSeatsBtn.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true));
        updateSeatsBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                updateSeatsBtnActionPerformed(evt);
            }
        });

        purchaseHistoryBtn.setBackground(new java.awt.Color(204, 204, 204));
        purchaseHistoryBtn.setFont(new java.awt.Font("Arial", 0, 13)); // NOI18N
        purchaseHistoryBtn.setForeground(new java.awt.Color(255, 255, 255));
        purchaseHistoryBtn.setText("Purchase History");
        purchaseHistoryBtn.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true));
            ...
            .addGroup(bannerLayout.createSequentialGroup()
                ...
                .addGroup(bannerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(bannerLayout.createSequentialGroup()
                        ...
                        .addGap(12, 12, 12)
                        .addComponent(purchaseHistoryBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(updateSeatsBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                ...
                .addGroup(bannerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(bannerLayout.createSequentialGroup()
                        ...
                        .addGroup(bannerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(updateSeatsBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(purchaseHistoryBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void updateSeatsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateSeatsBtnActionPerformed
        // Redirects admin to the update seats page
        AdminSeating adminSeatingFrame = new AdminSeating();
        adminSeatingFrame.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_updateSeatsBtnActionPerformed
    ...
    private void purchaseHistoryBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_purchaseHistoryBtnActionPerformed
        ...
        PurchaseHistory purchaseHistoryFrame = new PurchaseHistory();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminSignedInHomepage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminSignedInHomepage().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton updateSeatsBtn;
